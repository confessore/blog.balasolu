...
As long as those converter attributes are defined on the abstract asset model, the deserilization behavior will occur and whichever concrete type is defined will be returned.
